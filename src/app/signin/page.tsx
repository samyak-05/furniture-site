  ...
  return (
    ...
    >
      ...
      <form className="flex flex-col gap-6" onSubmit={handleSignIn}>
        <div className="group flex flex-col gap-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-7 pr-4 py-2 bg-transparent border-b border-gray-200 focus:border-black outline-none transition-all duration-300 placeholder:text-gray-300 text-sm text-black"
        ...
        <div className="group flex flex-col gap-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="••••••••"
              className="w-full pl-7 pr-10 py-2 bg-transparent border-b border-gray-200 focus:border-black outline-none transition-all duration-300 placeholder:text-gray-300 text-sm text-black"
        ...
        <button 
          type="button" 
          className="w-full flex items-center justify-center gap-3 py-3.5 rounded-full border border-gray-200 text-gray-600 text-sm font-semibold hover:bg-gray-50 transition-all duration-300 cursor-pointer" 
...
export default function Signup() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-[#FAF9F6] overflow-hidden selection:bg-black selection:text-white">
      <div className="absolute top-[-10%] right-[-5%] w-125 h-125 bg-[#E8E1D9] rounded-full mix-blend-multiply filter blur-[120px] opacity-70"></div>
      ...
      <Suspense fallback={<div className="text-sm tracking-widest text-gray-400 uppercase">Loading Form...</div>}>
        <SignInForm />
      </Suspense>
      ...
      <motion.div
        ...
        className="mt-8 text-sm text-gray-400 flex items-center gap-1 z-10"
      >
        Don't have an account?
        <button className="text-[#2A3439] font-semibold hover:underline underline-offset-4 decoration-1 cursor-pointer" onClick={() => router.push("/signup")}>
          Sign Up
        </button>
      </motion.div>
    </div>
